...
> 基于 `JD + 简历` 生成专属面试问题，模拟更接近真实大厂风格的技术面、HR 面与薪资谈判。

[![Version](https://img.shields.io/badge/version-1.0.0-green)]()
[![License](https://img.shields.io/badge/license-MIT-orange)]()

<img src="assets/readme-banner.png" alt="Jailbreak Foundry Banner" width="100%">
...
[快速开始](#-快速开始) · [它适合谁](#-它适合谁) · [它解决什么问题](#-它解决什么问题) · [功能亮点](#-功能亮点) · [为什么比通用-prompt-更有效](#-为什么比通用-prompt-更有效) · [支持公司](#-支持公司) · [输出示例](#-输出示例) · [更新计划](#-更新计划)
