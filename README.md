...
> 基于 `JD + 简历` 生成专属面试问题，模拟更接近真实大厂风格的技术面、HR 面与薪资谈判。现已支持国内大厂与海外大厂。
...
[News](#news) · [快速开始](#-快速开始) · [它适合谁](#-它适合谁) · [它解决什么问题](#-它解决什么问题) · [功能亮点](#-功能亮点) · [为什么比通用-prompt-更有效](#-为什么比通用-prompt-更有效) · [真实 Demo](#-真实-demo-案例) · [支持公司](#-支持公司) · [输出示例](#-输出示例) · [FAQ](#-faq) · [更新计划](#-更新计划)
...
| 通用 Prompt 常见问题 | 这个 Skill 的差异 |
|---------|-----------------|
| 问题泛，不够贴岗位| 结合真实 JD，而不是泛泛聊岗位 |
| 不看你的简历背景| 结合你的简历，而不是默认你背景完整 |
| 不区分公司风格| 更关注面试官为什么会问这个问题 |
| 很难识别你真正的风险点 | 输出不仅有题，还有匹配度和补强建议 |
...
- 目标岗位：字节跳动后端工程师
- JD 要求：分布式系统、MySQL、Redis、Go
- 候选人背景：3 年 Java 后端，做过电商系统
...
<img src="assets/ali-JD.jpg" alt="阿里技术运营官面试模拟报告 Demo" width="100%">

### Demo 输出 2：再做 JD vs 简历匹配度分析

接着，Skill 会把 JD 要求和简历经历逐项对齐，明确强匹配、需补强和简历弱点。这样候选人不只是拿到一组问题，还能知道自己最应该补哪块表达。

<img src="assets/liang-JD-analysis.jpg" alt="JD vs 简历匹配度分析 Demo" width="100%">
